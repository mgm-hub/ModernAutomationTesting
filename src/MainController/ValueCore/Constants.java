...
public class Constants {
    ...
    public static String STARTING_TEST = "Starting Test";

    public static String STEP_0 = "0.0";
    public static String STEP_1 = "0.1";
    public static String STEP_2 = "0.2";
    public static String STEP_3 = "0.3";
    public static String STEP_4 = "0.4";
